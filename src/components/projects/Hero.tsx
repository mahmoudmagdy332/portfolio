import image from "@/assets/images/trash/project-hero.png";
const Hero = () => {
  return (
    <div className="h-[600px] relative">
        <div className="absolute left-0 top-0 h-full w-full flex flex-col items-center justify-center gap-2">

            <h1 className="italic 2xl:text-[120px] xl:text-[100px] md:text-[80px]  text-[40px] font-Poppins text-primary font-thin">Projects</h1>
